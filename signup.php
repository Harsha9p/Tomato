...
<title>Tomato signup page</title>
...
<nav class="navbar navbar-expand-md   navbar-dark">
  <a class="navbar-brand" href="index.php"><h3 class="px-5">Tomato</h3></a>
...
<div class="signup-form ">
    ...
    <form method="post">
        ...
        <div class="form-group">
        	<input id="text" type="text" class="form-control"  placeholder="user_name" name="user_name">
        </div>
		<div class="form-group">
      <input id="text" class="form-control"  placeholder="Password" type="password" name="password">
        </div>
	      
    
		<div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg" id="button" type="submit" value="Signup">Sign Up</button>
	...
	<div class="hint-text">Already have an account? <a href="loginform.php">Login here</a></div>
</div>
</body>
