...
<head>
  ...
  <style>
    ...
    .container-fluid{
        background-image: url("images/banner11111.jpg");
height: 250px;
position: relative;
  text-align: center;
    }
...
<body>
  <section class="vh-100" style="background-color: #d6cbcd;">
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="post">
                    ...
                    <div class="d-flex align-items-center mb-3 pb-1">
                      ...
                      <span class="h1 fw-bold mb-0 logo">Tomato</span>
                    </div>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="password" id="text"  name="password" class="form-control form-control-lg" />
                     
                      <label class="form-label" for="form2Example27">Password</label>
                    </div>
  
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" id="button" type="submit" value="Login">Login</button>
                    </div>
